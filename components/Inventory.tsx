      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-slate-400 text-sm">
            Manage shop items, stock levels, and pricing.
          </p>
        </div>
        <button
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-3 mt-3 text-sm">
                      ...
                      <div className="flex items-center gap-1">
                        <span
                          className={`font-mono ${item.stock === 0 ? "text-red-400" : item.stock <= 5 ? "text-amber-400" : "text-slate-300"}`}
                        >
                          Stock: {item.stock}
                        </span>
                        {item.stock <= 5 && (
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-800/50 border-b border-slate-700">
                  <th className="p-4 w-20 text-xs font-semibold text-slate-400 uppercase tracking-wider">
                    Image
                  </th>
